        ...
        <div class="section_right">
          ...
          <form action="reserve_form.php" method="post">
            ...
            <p><label for="stay">宿泊数:</label>
              <input type="number" id="stay" name="stay" min="1" required>
            </p>

            <p><label for="adult">大人:</label>
              <input type="number" id="adult" name="adult" min="1" max="6" required>
            </p>
            <p><label for="child">子供:</label>
              <input type="number" id="child" name="child" min="0" max="4" required>
            </p>
