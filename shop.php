    ...
    <div id="container">
        ...
        <main>
            <article>
                ...
                <div>
                <a href="all_products.php" method="post">
                ...
                <div>
                <a href="all_products.php" method="post">
                <img src="image/mug2.jpg" alt="マグカップ">
                </a>
                </div>
                <div>
                <a href="all_products.php" method="post">
        ...
        infinite: true
                ...
                <section id="all" class="contents">
                    <div class="page_description right_flow">
                        <h1 class="title-style">
                            <p class="title-border-right"><a href="all_products.php">ALL&nbsp;PRODUCTS</a></p>
                        </h1>
                    </div>
                        <figure class="contents_img"><a href="all_products.php"><img src="image/25425413_s.jpg" alt="一式"></a></figure>
                </section>
                <section id="collaboration" class="contents">
                    <div class="page_description right_flow">
                        <h1 class="title-style">
                            <p class="title-border-left"><a href="collaboration.php">COLLABORATION</a></p>
                        </h1>
                    </div>
                    <figure class="contents_img"><a href="collaboration.php"><img src="image/bottle.jpg" alt="ボトル"></a></figure>
                </section>
                
                <section id="popular" class="contents">
                    <div class="page_description">
                        <h1 class="title-style">
                            <p class="title-border-right"><a href="popular.php">POPULAR</a></p>
                        </h1>
                        </div>
                        <figure class="cotents_img"><a href="popular.php"><img src="image/bed.jpg" alt="ベッド"></a></figure>
                </section>
        </main>
        <footer class="footer">
        <div class="ft">
