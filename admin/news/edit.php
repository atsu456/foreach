                    ...
                    <div class="admin">
                        <form action="edit_done.php" method="post">
                            <dl>
                                ...
                                <dd><input type="text" name="title" id="title"><?= $result['title'] ?></dd>
                                <dt><label for="topics_date">日付</label></dt>
                                <dd><input type="date" name="topics_date" id="topics_date" value="<?= $result['topics_date'] ?>">
                                <dt><label for="article">テキスト</label></dt>
                                <dd><textarea name="article" id="article"><?= $result['article'] ?></textarea></dd>
                                <dt><label for="news_image">image</label></dt>
                                <dd>
                                <img src= "<?= '../../image/' . $result['news_image'] ?>" alt="">
                                <input type="hidden" name="image_before" id="image_before" value="<?= $result['news_image'] ?>"><br>
